...
*/
export function translate_emoji_into_name(language, explain) {
    wasm.translate_emoji_into_name(language, explain);
}
...
* @returns {string}
*/
export function replace_emoji_with_name(text, language, explain) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.replace_emoji_with_name(retptr, ptr0, len0, language, explain);
...
* @param {boolean} explain
*/
export function translate_name_into_emoji(explain) {
    wasm.translate_name_into_emoji(explain);
}
...
* @returns {string}
*/
export function replace_name_with_emoji(text, explain) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.replace_name_with_emoji(retptr, ptr0, len0, explain);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('emojikingdom_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
